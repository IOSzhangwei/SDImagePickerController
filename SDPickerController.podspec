...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "zhangwei111"
  # s.authors            = { "zhangwei111" => "18580228790@163.com" }
  # s.social_media_url   = "http://twitter.com/zhangwei111"
  ...
  s.source       = { :git => "https://github.com/IOSzhangwei/SDImagePickerController.git", :tag => "1.0.2" }
